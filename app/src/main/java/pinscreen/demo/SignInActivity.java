...
public class SignInActivity extends AppCompatActivity {
        ...
        SignInButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                auth.signInWithEmailAndPassword(email, password)
                        .addOnCompleteListener(pinscreen.demo.SignInActivity.this, new OnCompleteListener<AuthResult>() {
                            @Override
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (!task.isSuccessful()) {
                                    ...
                                    Intent intent = new Intent(pinscreen.demo.SignInActivity.this, pinscreen.demo.HomeActivity.class);
    ...
    public void NavigateSignUp(View v) {
        Intent inent = new Intent(this, pinscreen.demo.SignUpActivity.class);
        startActivity(inent);
    }
    public void NavigateForgetMyPassword(View v) {
        Intent inent = new Intent(this, pinscreen.demo.ResetPasswordActivity.class);
        startActivity(inent);
    }
}
