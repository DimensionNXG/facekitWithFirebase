            ...
            public void onClick(View v) {
                ...
                if (pass.length()<8){
                    ...
                    auth.createUserWithEmailAndPassword(email,pass)
                            .addOnCompleteListener(pinscreen.demo.SignUpActivity.this, new OnCompleteListener<AuthResult>() {
                                public void onComplete(@NonNull Task<AuthResult> task) {

                                    if (!task.isSuccessful()) {
                                        Toast.makeText(pinscreen.demo.SignUpActivity.this, "ERROR", Toast.LENGTH_LONG).show();
                                    }
                                    else {
                                        startActivity(new Intent(pinscreen.demo.SignUpActivity.this, EditProfileActivity.class));
                                        finish();
                                    }
                                }
                            });}
