...
public class ProfileActivity  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange( DataSnapshot dataSnapshot) {
                pinscreen.demo.Userinformation userProfile = dataSnapshot.getValue(pinscreen.demo.Userinformation.class);
            ...
            public void onCancelled( DatabaseError databaseError) {
                Toast.makeText(pinscreen.demo.ProfileActivity.this, databaseError.getCode(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void navigateLogOut(View v){
        ...
        Intent inent = new Intent(this, pinscreen.demo.MainActivity.class);
        startActivity(inent);
    }
}